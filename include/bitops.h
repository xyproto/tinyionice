...
#define bswap_32(x) ((uint32_t)( \
    (((uint32_t)(x)&0x000000FF) << 24) | (((uint32_t)(x)&0x0000FF00) << 8) | (((uint32_t)(x)&0x00FF0000) >> 8) | (((uint32_t)(x)&0xFF000000) >> 24)))
#endif

#ifndef bswap_64
#define bswap_64(x) ((uint64_t)( \
    (((uint64_t)(x)&0x00000000000000FFULL) << 56) | (((uint64_t)(x)&0x000000000000FF00ULL) << 40) | (((uint64_t)(x)&0x0000000000FF0000ULL) << 24) | (((uint64_t)(x)&0x00000000FF000000ULL) << 8) | (((uint64_t)(x)&0x000000FF00000000ULL) >> 8) | (((uint64_t)(x)&0x0000FF0000000000ULL) >> 24) | (((uint64_t)(x)&0x00FF000000000000ULL) >> 40) | (((uint64_t)(x)&0xFF00000000000000ULL) >> 56)))
#endif
